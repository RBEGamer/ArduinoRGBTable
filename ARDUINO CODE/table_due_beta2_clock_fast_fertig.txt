...
//clear_screen();
  int on_color = strip.Color(0, 0, 255);
  ...
  clock_copy_arr(me, 4);
    ...
    for (int j = 0; j < 7; j++){       
      ...
      if(time1[3-i][6-j] == 1){    
        strip.setPixelColor(get_led_number(i+time1_anchor[0],j+time1_anchor[1]),  strip.Color(0, 0, 255)); 
      }else{    
    ...
    for (int j = 0; j < 7; j++){       
      if(clock_orientation == 1){
      if(time2[3-i][6-j] == 1){    
        strip.setPixelColor(get_led_number(i+time2_anchor[0],j+time2_anchor[1]),  strip.Color(0, 0, 255)); 
      }else{    
    ...
    for (int j = 0; j < 7; j++){       
      if(clock_orientation == 1){
      if(time3[3-i][6-j] == 1){    
        strip.setPixelColor(get_led_number(i+time3_anchor[0],j+time3_anchor[1]),  strip.Color(0, 255, 0)); 
      }else{    
    ...
    for (int j = 0; j < 7; j++){       
      if(clock_orientation == 1){
      if(time4[3-i][6-j] == 1){    
        strip.setPixelColor(get_led_number(i+time4_anchor[0],j+time4_anchor[1]),  strip.Color(0, 255, 0)); 
      }else{    
...
server<<"   <table width='50%' border='0'>";
server<<"   <tr>";
server<<"    <td scope='col'> <label for='x'>x</label></td>";
server<<"    <td>";
server<<"    SPEED : <br>";
server<<"    </td> ";
server<<"    <td scope='col' >";
server<<"    <input name='x' type='number' id='x' max='20' min='0' step='1' value='"; server<<x;server <<"' size='5'><br>";
server<<"     </td>  ";
server<<"      <td colspan='2'><input type='submit' value='SAVE' /></td>";
server<<"  </tr>";
server<<"   </table> ";
...
server<<"   <table width='50%' border='0'>";
server<<"   <tr>";
server<<"    <td scope='col'> <label for='y'>y</label></td>";
server<<"    <td>";
server<<"    SPEED : <br>";
server<<"    </td> ";
server<<"    <td scope='col' >";
server<<"    <input name='y' type='number' id='y' max='20' min='0' step='1' value='"; server<<y;server <<"' size='5'><br>";
server<<"     </td>  ";
server<<"      <td colspan='2'><input type='submit' value='SAVE' /></td>";
server<<"  </tr>";
server<<"   </table> ";
